...
[ActionType(nameof(BuyCookingEquipment))]
public class BuyCookingEquipment : SVRAction
{
    public int RecipeID;
    public Guid FoodStateID;
    public List<Guid> RefrigeratorStateIDs;

    public BuyCookingEquipment()
    {
    }

    public BuyCookingEquipment(int recipeID, Guid foodStateID, List<Guid> refrigeratorStateIDs)
    {
        RecipeID = recipeID;
