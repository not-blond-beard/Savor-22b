...
[ActionType(nameof(CancelRegisteredTradeGoodAction))]
public class CancelRegisteredTradeGoodAction : SVRAction
{
    public CancelRegisteredTradeGoodAction() { }

    public CancelRegisteredTradeGoodAction(Guid productId)
    {
        ProductId = productId;
    }
