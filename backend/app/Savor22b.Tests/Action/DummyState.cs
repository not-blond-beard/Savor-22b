...
public class DummyState : IAccountStateDelta, IValidatorSupportStateDelta
{
    ...
    public IAccountStateDelta SetState(Address address, IValue state) =>
        new DummyState(_state.SetItem(address, state), _balance);
    ...
    )
    {
        ...
        return new DummyState(_state, newBalance);
    }
